...
```bash
docker-compose exec web odoo -d odoo -i cater --stop-after-init --without-demo=False
...
- **Database**: `odoo` (auto-created with demo data)
...
```bash
# PostgreSQL Direct
psql postgresql://odoo:odoo_password@localhost:5432/odoo
...
docker-compose exec web odoo -u cater --stop-after-init
docker-compose restart web
```
...
# Update module
docker-compose exec web odoo -u cater -d odoo --stop-after-init
